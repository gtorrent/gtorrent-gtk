...
GtkStatusBox::GtkStatusBox()
{
	...
	m_save_as_label       .set_markup("<b>SaveAs:</b>");
	m_uploaded_label      .set_markup("<b>Uploaded:</b>");
	m_up_limit_label      .set_markup("<b>UpLimit:</b>");
	m_remaining_label     .set_markup("<b>Remaining:</b>");
	m_total_size_label    .set_markup("<b>TotalSize:</b>");
	m_downloaded_label    .set_markup("<b>Downloaded:</b>");
	m_down_limit_label    .set_markup("<b>DownLimit:</b>");
	m_share_ratio_label   .set_markup("<b>ShareRatio:</b>");
	m_tracker_url_label   .set_markup("<b>TrackerURL:</b>");
	m_time_elapsed_label  .set_markup("<b>TimeElapsed:</b>");
	m_upload_speed_label  .set_markup("<b>UploadSpeed:</b>");
	m_download_speed_label.set_markup("<b>DownloadSpeed:</b>");
	m_tracker_status_label.set_markup("<b>TrackerStatus:</b>");
