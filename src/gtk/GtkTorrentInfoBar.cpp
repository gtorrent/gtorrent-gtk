	...
	: Gtk::Box(Gtk::ORIENTATION_VERTICAL)
{
	...
	m_table_layout 									= Gtk::manage			(new Gtk::Table(62, 2, false));
	...
	m_name_label 										= Gtk::manage			(new Gtk::Label());
	m_name_label										->set_markup			("<b>name</b>");
	m_name 													= Gtk::manage			(new Gtk::Label("0"));
	m_table_layout									->attach					(*m_name_label, 										0, 1, 2, 3, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*(new Gtk::VSeparator()), 					1, 2, 0, 1, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*m_name, 													2, 3, 2, 3, Gtk::AttachOptions::SHRINK);
	...
	m_table_layout									->attach					(*m_torrent_file_label, 						0, 1, 3, 4, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*(new Gtk::VSeparator()),				 	1, 2, 0, 1, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*m_torrent_file, 									2, 3, 3, 4, Gtk::AttachOptions::SHRINK);
	...
	m_table_layout									->attach					(*m_down_total_label, 							0, 1, 4, 5, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*(new Gtk::VSeparator()), 					1, 2, 0, 1, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*m_down_total, 										2, 3, 4, 5, Gtk::AttachOptions::SHRINK);
	...
	m_table_layout									->attach					(*m_down_total_label, 							0, 1, 6, 7, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*(new Gtk::VSeparator()), 					1, 2, 0, 1, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*m_down_total, 										2, 3, 6, 7, Gtk::AttachOptions::SHRINK);
	...
	m_table_layout									->attach					(*m_down_total_label, 							0, 1, 7, 8, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*(new Gtk::VSeparator()), 					1, 2, 0, 1, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*m_down_total, 										2, 3, 7, 8, Gtk::AttachOptions::SHRINK);

	m_up_total_label 								= Gtk::manage			(new Gtk::Label());
	m_up_total_label								->set_markup			("<b>uploaded</b>");
	m_up_total 											= Gtk::manage			(new Gtk::Label());
	m_table_layout									->attach					(*m_up_total_label, 								0, 1, 8, 9, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*(new Gtk::VSeparator()), 					1, 2, 1, 2, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*m_up_total, 											2, 3, 8, 9, Gtk::AttachOptions::SHRINK);
	...
	m_table_layout									->attach					(*m_added_time_label, 							0, 1, 9,10, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*(new Gtk::VSeparator()), 					1, 2, 1, 2, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*m_added_time, 										2, 3, 9,10, Gtk::AttachOptions::SHRINK);
	...
	m_table_layout									->attach					(*m_completed_time_label, 					0, 1,10,11, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*(new Gtk::VSeparator()), 					1, 2, 1, 2, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*m_completed_time, 								2, 3,10,11, Gtk::AttachOptions::SHRINK);
	...
	m_table_layout									->attach					(*m_last_seen_complete_label, 			0, 1,11,12, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*(new Gtk::VSeparator()), 					1, 2, 1, 2, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*m_last_seen_complete, 						2, 3,11,12, Gtk::AttachOptions::SHRINK);

	m_storage_mode_label 						= Gtk::manage			(new Gtk::Label());
	m_storage_mode_label						->set_markup			("<b>storage mode</b>");
	m_storage_mode 									= Gtk::manage			(new Gtk::Label());
	m_table_layout									->attach					(*m_up_total_label, 								0, 1,12,13, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*(new Gtk::VSeparator()), 					1, 2, 1, 2, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*m_up_total, 											2, 3,12,13, Gtk::AttachOptions::SHRINK);
	...
	m_table_layout									->attach					(*m_progress_ppm_label, 						0, 1,13,14, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*(new Gtk::VSeparator()), 					1, 2, 1, 2, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*m_progress_ppm, 									2, 3,13,14, Gtk::AttachOptions::SHRINK);
	...
	m_table_layout									->attach					(*m_queue_position_label, 					0, 1,14,15, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*(new Gtk::VSeparator()), 					1, 2, 1, 2, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*m_queue_position, 								2, 3,14,15, Gtk::AttachOptions::SHRINK);
	...
	m_table_layout									->attach					(*m_download_rate_label, 						0, 1,15,16, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*(new Gtk::VSeparator()), 					1, 2, 1, 2, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*m_download_rate, 									2, 3,15,16, Gtk::AttachOptions::SHRINK);
	...
	m_table_layout									->attach					(*m_upload_rate_label, 							0, 1,16,17, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*(new Gtk::VSeparator()), 					1, 2, 1, 2, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*m_upload_rate, 										2, 3,16,17, Gtk::AttachOptions::SHRINK);
	...
	m_table_layout									->attach					(*m_download_payload_rate_label,		0, 1,17,18, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*(new Gtk::VSeparator()), 					1, 2, 1, 2, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*m_download_payload_rate, 					2, 3,17,18, Gtk::AttachOptions::SHRINK);
	...
	m_table_layout									->attach					(*m_upload_payload_rate_label, 			0, 1,18,19, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*(new Gtk::VSeparator()), 					1, 2, 1, 2, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*m_upload_payload_rate, 						2, 3,18,19, Gtk::AttachOptions::SHRINK);

	m_num_seeds_label 							= Gtk::manage			(new Gtk::Label());
	m_num_seeds_label								->set_markup			("<b>num seeds</b>");
	m_num_seeds 										= Gtk::manage			(new Gtk::Label());
	m_table_layout									->attach					(*m_num_seeds_label, 								0, 1,19,20, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*(new Gtk::VSeparator()), 					1, 2, 1, 2, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*m_num_seeds, 											2, 3,19,20, Gtk::AttachOptions::SHRINK);

	m_num_peers_label 							= Gtk::manage			(new Gtk::Label());
	m_num_peers_label								->set_markup			("<b>num peers</b>");
	m_num_peers 										= Gtk::manage			(new Gtk::Label());
	m_table_layout									->attach					(*m_num_peers_label, 								0, 1,20,21, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*(new Gtk::VSeparator()), 					1, 2, 1, 2, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*m_num_peers, 											2, 3,20,21, Gtk::AttachOptions::SHRINK);
	...
	m_table_layout									->attach					(*m_num_complete_label, 						0, 1,21,22, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*(new Gtk::VSeparator()), 					1, 2, 1, 2, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*m_num_complete, 									2, 3,21,22, Gtk::AttachOptions::SHRINK);
	...
	m_table_layout									->attach					(*m_num_incomplete_label, 					0, 1,22,23, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*(new Gtk::VSeparator()), 					1, 2, 1, 2, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*m_num_incomplete, 								2, 3,22,23, Gtk::AttachOptions::SHRINK);

	m_list_seeds_label 							= Gtk::manage			(new Gtk::Label());
	m_list_seeds_label							->set_markup			("<b>list seeds</b>");
	m_list_seeds 										= Gtk::manage			(new Gtk::Label());
	m_table_layout									->attach					(*m_list_seeds_label, 							0, 1,23,24, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*(new Gtk::VSeparator()), 					1, 2, 1, 2, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*m_list_seeds, 										2, 3,23,24, Gtk::AttachOptions::SHRINK);

	m_list_peers_label 							= Gtk::manage			(new Gtk::Label());
	m_list_peers_label							->set_markup			("<b>list peers</b>");
	m_list_peers 										= Gtk::manage			(new Gtk::Label());
	m_table_layout									->attach					(*m_list_peers_label, 							0, 1,24,25, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*(new Gtk::VSeparator()), 					1, 2, 1, 2, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*m_list_peers, 										2, 3,24,25, Gtk::AttachOptions::SHRINK);
	...
	m_table_layout									->attach					(*m_connect_candidates_label, 			0, 1,25,26, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*(new Gtk::VSeparator()), 					1, 2, 1, 2, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*m_connect_candidates, 						2, 3,25,26, Gtk::AttachOptions::SHRINK);
	...
	m_table_layout									->attach					(*m_num_pieces_label, 							0, 1,26,27, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*(new Gtk::VSeparator()), 					1, 2, 1, 2, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*m_num_pieces, 										2, 3,26,27, Gtk::AttachOptions::SHRINK);
	...
	m_table_layout									->attach					(*m_distributed_full_copies_label, 	0, 1,27,28, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*(new Gtk::VSeparator()), 					1, 2, 1, 2, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*m_distributed_full_copies, 				2, 3,27,28, Gtk::AttachOptions::SHRINK);
	...
	m_table_layout									->attach					(*m_distributed_fraction_label, 		0, 1,28,29, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*(new Gtk::VSeparator()), 					1, 2, 1, 2, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*m_distributed_fraction, 					2, 3,28,29, Gtk::AttachOptions::SHRINK);
	...
	m_table_layout									->attach					(*m_distributed_copies_label, 			0, 1,29,30, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*(new Gtk::VSeparator()), 					1, 2, 1, 2, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*m_distributed_copies, 						2, 3,29,30, Gtk::AttachOptions::SHRINK);
	...
	m_table_layout									->attach					(*m_block_size_label, 							0, 1,30,31, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*(new Gtk::VSeparator()), 					1, 2, 1, 2, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*m_block_size, 										2, 3,30,31, Gtk::AttachOptions::SHRINK);
	...
	m_table_layout									->attach					(*m_num_uploads_label, 							0, 1,31,32, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*(new Gtk::VSeparator()), 					1, 2, 1, 2, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*m_num_uploads, 										2, 3,31,32, Gtk::AttachOptions::SHRINK);
	...
	m_table_layout									->attach					(*m_num_connections_label, 					0, 1,32,33, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*(new Gtk::VSeparator()), 					1, 2, 1, 2, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*m_num_connections, 								2, 3,32,33, Gtk::AttachOptions::SHRINK);
	...
	m_table_layout									->attach					(*m_uploads_limit_label, 						0, 1,33,34, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*(new Gtk::VSeparator()), 					1, 2, 1, 2, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*m_uploads_limit, 									2, 3,33,34, Gtk::AttachOptions::SHRINK);
	...
	m_table_layout									->attach					(*m_connections_limit_label, 				0, 1,34,35, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*(new Gtk::VSeparator()), 					1, 2, 1, 2, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*m_connections_limit, 							2, 3,34,35, Gtk::AttachOptions::SHRINK);
	...
	m_table_layout									->attach					(*m_up_bandwidth_queue_label, 			0, 1,35,36, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*(new Gtk::VSeparator()), 					1, 2, 1, 2, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*m_up_bandwidth_queue, 						2, 3,35,36, Gtk::AttachOptions::SHRINK);
	...
	m_table_layout									->attach					(*m_down_bandwidth_queue_label, 		0, 1,36,37, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*(new Gtk::VSeparator()), 					1, 2, 1, 2, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*m_down_bandwidth_queue, 					2, 3,36,37, Gtk::AttachOptions::SHRINK);
	...
	m_table_layout									->attach					(*m_time_since_upload_label, 				0, 1,37,38, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*(new Gtk::VSeparator()), 					1, 2, 1, 2, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*m_time_since_upload, 							2, 3,37,38, Gtk::AttachOptions::SHRINK);
	...
	m_table_layout									->attach					(*m_time_since_download_label, 			0, 1,38,39, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*(new Gtk::VSeparator()), 					1, 2, 1, 2, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*m_time_since_download, 						2, 3,38,39, Gtk::AttachOptions::SHRINK);
	...
	m_table_layout									->attach					(*m_active_time_label, 							0, 1,39,40, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*(new Gtk::VSeparator()), 					1, 2, 1, 2, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*m_active_time, 										2, 3,39,40, Gtk::AttachOptions::SHRINK);
	...
	m_table_layout									->attach					(*m_finished_time_label, 						0, 1,40,41, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*(new Gtk::VSeparator()), 					1, 2, 1, 2, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*m_finished_time, 									2, 3,40,41, Gtk::AttachOptions::SHRINK);
	...
	m_table_layout									->attach					(*m_seeding_time_label, 						0, 1,41,42, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*(new Gtk::VSeparator()), 					1, 2, 1, 2, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*m_seeding_time, 									2, 3,41,42, Gtk::AttachOptions::SHRINK);

	m_seed_rank_label 							= Gtk::manage			(new Gtk::Label());
	m_seed_rank_label								->set_markup			("<b>seed rank</b>");
	m_seed_rank 										= Gtk::manage			(new Gtk::Label());
	m_table_layout									->attach					(*m_seed_rank_label, 								0, 1,42,43, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*(new Gtk::VSeparator()), 					1, 2, 1, 2, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*m_seed_rank, 											2, 3,42,43, Gtk::AttachOptions::SHRINK);
	...
	m_table_layout									->attach					(*m_last_scrape_label, 							0, 1,43,44, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*(new Gtk::VSeparator()), 					1, 2, 1, 2, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*m_last_scrape, 										2, 3,43,44, Gtk::AttachOptions::SHRINK);

	m_sparse_regions_label 					= Gtk::manage			(new Gtk::Label());
	m_sparse_regions_label					->set_markup			("<b>sparse regions</b>");
	m_sparse_regions 								= Gtk::manage			(new Gtk::Label());
	m_table_layout									->attach					(*m_sparse_regions_label, 					0, 1,44,45, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*(new Gtk::VSeparator()), 					1, 2, 1, 2, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*m_sparse_regions, 								2, 3,44,45, Gtk::AttachOptions::SHRINK);

	m_priority_label 								= Gtk::manage			(new Gtk::Label());
	m_priority_label								->set_markup			("<b>priority</b>");
	m_priority 											= Gtk::manage			(new Gtk::Label());
	m_table_layout									->attach					(*m_priority_label, 								0, 1,45,46, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*(new Gtk::VSeparator()), 					1, 2, 1, 2, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*m_priority, 											2, 3,45,46, Gtk::AttachOptions::SHRINK);

	m_state_label 									= Gtk::manage			(new Gtk::Label());
	m_state_label										->set_markup			("<b>state</b>");
	m_state 												= Gtk::manage			(new Gtk::Label());
	m_table_layout									->attach					(*m_state_label, 										0, 1,46,47, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*(new Gtk::VSeparator()), 					1, 2, 1, 2, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*m_state, 													2, 3,46,47, Gtk::AttachOptions::SHRINK);
	...
	m_table_layout									->attach					(*m_need_save_resume_label, 				0, 1,47,48, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*(new Gtk::VSeparator()), 					1, 2, 1, 2, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*m_need_save_resume, 							2, 3,47,48, Gtk::AttachOptions::SHRINK);
	...
	m_table_layout									->attach					(*m_ip_filter_applies_label, 				0, 1,48,49, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*(new Gtk::VSeparator()), 					1, 2, 1, 2, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*m_ip_filter_applies, 							2, 3,48,49, Gtk::AttachOptions::SHRINK);
	...
	m_table_layout									->attach					(*m_upload_mode_label, 							0, 1,49,50, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*(new Gtk::VSeparator()), 					1, 2, 1, 2, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*m_upload_mode, 										2, 3,49,50, Gtk::AttachOptions::SHRINK);
	...
	m_table_layout									->attach					(*m_share_mode_label, 							0, 1,50,51, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*(new Gtk::VSeparator()), 					1, 2, 1, 2, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*m_share_mode, 										2, 3,50,51, Gtk::AttachOptions::SHRINK);
	...
	m_table_layout									->attach					(*m_super_seeding_label, 						0, 1,51,52, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*(new Gtk::VSeparator()), 					1, 2, 1, 2, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*m_super_seeding, 									2, 3,51,52, Gtk::AttachOptions::SHRINK);

	m_paused_label 									= Gtk::manage			(new Gtk::Label());
	m_paused_label									->set_markup			("<b>paused</b>");
	m_paused 												= Gtk::manage			(new Gtk::Label());
	m_table_layout									->attach					(*m_paused_label, 									0, 1,52,53, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*(new Gtk::VSeparator()), 					1, 2, 1, 2, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*m_paused, 												2, 3,52,53, Gtk::AttachOptions::SHRINK);
	...
	m_table_layout									->attach					(*m_auto_managed_label, 						0, 1,53,54, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*(new Gtk::VSeparator()), 					1, 2, 1, 2, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*m_auto_managed, 									2, 3,53,54, Gtk::AttachOptions::SHRINK);
	...
	m_table_layout									->attach					(*m_sequential_download_label, 			0, 1,54,55, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*(new Gtk::VSeparator()), 					1, 2, 1, 2, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*m_sequential_download, 						2, 3,54,55, Gtk::AttachOptions::SHRINK);
	...
	m_table_layout									->attach					(*m_is_seeding_label, 							0, 1,55,56, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*(new Gtk::VSeparator()), 					1, 2, 1, 2, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*m_is_seeding, 										2, 3,55,56, Gtk::AttachOptions::SHRINK);
	...
	m_table_layout									->attach					(*m_is_finished_label, 							0, 1,56,57, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*(new Gtk::VSeparator()), 					1, 2, 1, 2, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*m_is_finished, 										2, 3,56,57, Gtk::AttachOptions::SHRINK);
	...
	m_table_layout									->attach					(*m_has_metadata_label, 						0, 1,57,58, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*(new Gtk::VSeparator()), 					1, 2, 1, 2, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*m_has_metadata, 									2, 3,57,58, Gtk::AttachOptions::SHRINK);
	...
	m_table_layout									->attach					(*m_has_incoming_label, 						0, 1,58,59, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*(new Gtk::VSeparator()), 					1, 2, 1, 2, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*m_has_incoming, 									2, 3,58,59, Gtk::AttachOptions::SHRINK);

	m_seed_mode_label 							= Gtk::manage			(new Gtk::Label());
	m_seed_mode_label								->set_markup			("<b>seed mode</b>");
	m_seed_mode 										= Gtk::manage			(new Gtk::Label());
	m_table_layout									->attach					(*m_seed_mode_label, 								0, 1,59,60, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*(new Gtk::VSeparator()), 					1, 2, 1, 2, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*m_seed_mode, 											2, 3,59,60, Gtk::AttachOptions::SHRINK);
	...
	m_table_layout									->attach					(*m_moving_storage_label, 					0, 1,60,61, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*(new Gtk::VSeparator()), 					1, 2, 1, 2, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*m_moving_storage, 								2, 3,60,61, Gtk::AttachOptions::SHRINK);

	m_info_hash_label 							= Gtk::manage			(new Gtk::Label());
	m_info_hash_label								->set_markup			("<b>info hash</b>");
	m_info_hash 										= Gtk::manage			(new Gtk::Label());
	m_table_layout									->attach					(*m_info_hash_label, 								0, 1,61,62, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*(new Gtk::VSeparator()), 					1, 2, 1, 2, Gtk::AttachOptions::SHRINK);
	m_table_layout									->attach					(*m_info_hash, 											2, 3,61,62, Gtk::AttachOptions::SHRINK);

	m_stat_box->pack_start(*(new Gtk::HSeparator()), Gtk::PACK_SHRINK);
	m_stat_box->pack_start(*m_table_layout, Gtk::PACK_SHRINK);

	m_notebook											->append_page			(*m_overview_box, 		"overview");
	m_notebook											->append_page			(*m_graph, 						"speed");
	m_notebook											->append_page			(*m_stat_box, 				"pieces");
...
void GtkTorrentInfoBar::updateInfo(shared_ptr<gt::Torrent> selected)
{
	...
	if(selectionExists)
	{
		...
		m_list_seeds									->set_text				(t[selectedIndex]->getListSeedsString());
		m_list_peers									->set_text				(t[selectedIndex]->getListPeersString());
		...
		m_sparse_regions 							->set_text				(t[selectedIndex]->getSparseRegionsString());
