	...
	: Gtk::Box(Gtk::ORIENTATION_VERTICAL)
{
	...
	m_info_table_layout ->attach(*m_state_label, 0, 1, 0, 1, Gtk::AttachOptions::SHRINK);
	m_info_table_layout ->attach(*(new Gtk::VSeparator()), 1, 2, 0, 1, Gtk::AttachOptions::SHRINK);
	m_info_table_layout ->attach(*m_state, 2, 3, 0, 1, Gtk::AttachOptions::SHRINK);
	...
	m_info_table_layout ->attach(*m_upload_rate_label, 0, 1, 1, 2, Gtk::AttachOptions::SHRINK);
	m_info_table_layout ->attach(*(new Gtk::VSeparator()), 1, 2, 1, 2, Gtk::AttachOptions::SHRINK);
	m_info_table_layout ->attach(*m_upload_rate, 2, 3, 1, 2, Gtk::AttachOptions::SHRINK);
	...
	m_info_table_layout ->attach(*m_download_rate_label, 0, 1, 2, 3, Gtk::AttachOptions::SHRINK);
	m_info_table_layout ->attach(*(new Gtk::VSeparator()), 1, 2, 2, 3, Gtk::AttachOptions::SHRINK);
	m_info_table_layout ->attach(*m_download_rate, 2, 3, 2, 3, Gtk::AttachOptions::SHRINK);
	...
	m_info_table_layout ->attach(*m_current_tracker_label, 0, 1, 3, 4, Gtk::AttachOptions::SHRINK);
	m_info_table_layout ->attach(*(new Gtk::VSeparator()), 1, 2, 3, 4, Gtk::AttachOptions::SHRINK);
	m_info_table_layout ->attach(*m_current_tracker, 2, 3, 3, 4, Gtk::AttachOptions::SHRINK);
	...
	m_info_table_layout ->attach(*m_save_path_label, 0, 1, 4, 5, Gtk::AttachOptions::SHRINK);
	m_info_table_layout ->attach(*(new Gtk::VSeparator()), 1, 2, 4, 5, Gtk::AttachOptions::SHRINK);
	m_info_table_layout ->attach(*m_save_path, 2, 3, 4, 5, Gtk::AttachOptions::SHRINK);

	m_info_hash_label = Gtk::manage(new Gtk::Label());
	m_info_hash_label ->set_markup("<b>Info Hash</b>");
	m_info_hash = Gtk::manage(new Gtk::Label());
	m_info_table_layout ->attach(*m_info_hash_label, 0, 1, 5, 6, Gtk::AttachOptions::SHRINK);
	m_info_table_layout ->attach(*(new Gtk::VSeparator()), 1, 2, 5, 6, Gtk::AttachOptions::SHRINK);
	m_info_table_layout ->attach(*m_info_hash, 2, 3, 5, 6, Gtk::AttachOptions::SHRINK);
	...
	m_info_table_layout ->attach(*m_eta_label, 0, 1, 8, 9, Gtk::AttachOptions::SHRINK);
	m_info_table_layout ->attach(*(new Gtk::VSeparator()), 1, 2, 8, 9, Gtk::AttachOptions::SHRINK);
	m_info_table_layout ->attach(*m_eta, 2, 3, 8, 9, Gtk::AttachOptions::SHRINK);
	...
	m_info_table_layout ->attach(*m_all_time_download_label, 0, 1, 10, 11, Gtk::AttachOptions::SHRINK);
	m_info_table_layout ->attach(*(new Gtk::VSeparator()), 1, 2, 10, 11, Gtk::AttachOptions::SHRINK);
	m_info_table_layout ->attach(*m_all_time_download, 2, 3, 10, 11, Gtk::AttachOptions::SHRINK);
	...
	m_info_table_layout ->attach(*m_active_time_label, 0, 1, 11, 12, Gtk::AttachOptions::SHRINK);
	m_info_table_layout ->attach(*(new Gtk::VSeparator()), 1, 11, 12, Gtk::AttachOptions::SHRINK);
	m_info_table_layout ->attach(*m_active_time, 2, 3, 11, 12, Gtk::AttachOptions::SHRINK);
	...
	m_info_table_layout ->attach(*m_seeding_time_label, 0, 1, 12, 13, Gtk::AttachOptions::SHRINK);
	m_info_table_layout ->attach(*(new Gtk::VSeparator()), 1, 2, 12, 13, Gtk::AttachOptions::SHRINK);
	m_info_table_layout ->attach(*m_seeding_time, 2, 3, 12, 13, Gtk::AttachOptions::SHRINK);
	...
	m_info_table_layout ->attach(*m_last_scrape_label, 0, 1, 13, 14, Gtk::AttachOptions::SHRINK);
	m_info_table_layout ->attach(*(new Gtk::VSeparator()), 1, 2, 13, 14, Gtk::AttachOptions::SHRINK);
	m_info_table_layout ->attach(*m_last_scrape, 2, 3, 13, 14, Gtk::AttachOptions::SHRINK);
	...
	m_info_table_layout ->attach(*m_connect_candidates_label, 0, 1, 14, 15, Gtk::AttachOptions::SHRINK);
	m_info_table_layout ->attach(*(new Gtk::VSeparator()), 1, 2, 14, 15, Gtk::AttachOptions::SHRINK);
	m_info_table_layout ->attach(*m_connect_candidates, 2, 3, 14, 15, Gtk::AttachOptions::SHRINK);
	...
	m_info_table_layout ->attach(*m_num_connections_label, 0, 1, 15, 16, Gtk::AttachOptions::SHRINK);
	m_info_table_layout ->attach(*(new Gtk::VSeparator()), 1, 2, 15, 16, Gtk::AttachOptions::SHRINK);
	m_info_table_layout ->attach(*m_num_connections, 2, 3, 15, 16, Gtk::AttachOptions::SHRINK);
	...
	m_info_table_layout ->attach(*m_num_incomplete_label, 0, 1, 19, 20, Gtk::AttachOptions::SHRINK);
	m_info_table_layout ->attach(*(new Gtk::VSeparator()), 1, 2, 19, 20, Gtk::AttachOptions::SHRINK);
	m_info_table_layout ->attach(*m_num_incomplete, 2, 3, 19, 20, Gtk::AttachOptions::SHRINK);
	...
	m_info_table_layout ->attach(*m_num_complete_label, 0, 1, 20, 21, Gtk::AttachOptions::SHRINK);
	m_info_table_layout ->attach(*(new Gtk::VSeparator()), 1, 2, 20, 21, Gtk::AttachOptions::SHRINK);
	m_info_table_layout ->attach(*m_num_complete, 2, 3, 20, 21, Gtk::AttachOptions::SHRINK);
	...
	m_info_table_layout ->attach(*m_distributed_copies_label, 0, 1, 22, 23, Gtk::AttachOptions::SHRINK);
	m_info_table_layout ->attach(*(new Gtk::VSeparator()), 1, 2, 22, 23, Gtk::AttachOptions::SHRINK);
	m_info_table_layout ->attach(*m_distributed_copies, 2, 3, 22, 23, Gtk::AttachOptions::SHRINK);
